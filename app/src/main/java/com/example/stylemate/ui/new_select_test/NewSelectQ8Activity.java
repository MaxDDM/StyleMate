...
public class NewSelectQ8Activity extends AppCompatActivity {
    int ans = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_select8);

        ImageButton test1Button = findViewById(R.id.btnSelTest18);
        ImageButton test2Button = findViewById(R.id.btnSelTest28);
        ImageButton test3Button = findViewById(R.id.btnSelTest38);
        ImageButton test4Button = findViewById(R.id.btnSelTest48);
        ImageButton nextButton = findViewById(R.id.btnNextQuestSelTest8);
        ImageButton skipButton = findViewById(R.id.btnSkipQuestSelTest8);
