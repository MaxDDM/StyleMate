...
public class NewSelectQ2Activity extends AppCompatActivity {
    int ans = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_select2);

        ImageButton test1Button = findViewById(R.id.btnSelTest12);
        ImageButton test2Button = findViewById(R.id.btnSelTest22);
        ImageButton test3Button = findViewById(R.id.btnSelTest32);
        ImageButton test4Button = findViewById(R.id.btnSelTest42);
        ImageButton nextButton = findViewById(R.id.btnNextQuestSelTest2);
        ...
        nextButton.setOnClickListener(v -> {
            if (ans != -1) {
                ActiveUserInfo.setDefaults("testSel" + ans, String.valueOf(ans), NewSelectQ2Activity.this);
            } else {
                Toast.makeText(NewSelectQ2Activity.this, "Вы не выбрали ни один из вариантов", Toast.LENGTH_LONG).show();
                return;
            }

            Intent intent = new Intent(NewSelectQ2Activity.this, NewSelectQ3Activity.class);
